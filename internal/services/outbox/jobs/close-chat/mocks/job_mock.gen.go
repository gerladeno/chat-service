...
func (m *MockchatsRepo) GetClientID(ctx context.Context, chatID types.ChatID) (types.UserID, error) {
	m.ctrl.T.Helper()
...
func (mr *MockchatsRepoMockRecorder) GetClientID(ctx, chatID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClientID", reflect.TypeOf((*MockchatsRepo)(nil).GetClientID), ctx, chatID)
}
