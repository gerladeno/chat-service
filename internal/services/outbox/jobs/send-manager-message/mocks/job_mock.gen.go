...
func (m *MockchatsRepository) GetUserID(ctx context.Context, chatID types.ChatID) (types.UserID, error) {
	m.ctrl.T.Helper()
...
func (mr *MockchatsRepositoryMockRecorder) GetUserID(ctx, chatID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserID", reflect.TypeOf((*MockchatsRepository)(nil).GetUserID), ctx, chatID)
}
